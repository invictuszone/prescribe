app.controller('dashboardController', function($scope, $timeout, $compile, $http, API_URL) {
  ...
  $http.get(API_URL + "subscriptions")
        .success(function(response) {
            ...
            $timeout(function(){
              $scope.Packages_TABLE =	$('#table-Packages-list').DataTable({
  ...
  $http.get(API_URL + "superAdmindashboard/")
          .success(function(response) {

              console.log("response: ",response);
              $scope.DailyClients         = response['dailyClients'];
              $scope.WeeklyClients        = response['weeklyClients'];
              $scope.MonthlyClients       = response['monthlyClients'];
