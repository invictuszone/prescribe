...
<html lang="en" ng-app="prescribeDiets">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Prescribe Diets | Super Admin</title>
        ...
        <div class="page-wrapper">
            <div class="page-wrapper-row">
                <div class="page-wrapper-top">
                    <!-- BEGIN HEADER -->
                    @include('superadmin.includes.header', ['active_page' => $active_page])
					<!-- END HEADER -->
                </div>
            </div>
...
<![endif]-->
        ...
        <script src="<?= asset('app/controllers/PreferencesController.js') ?>"></script>
        <!-- BEGIN PAGE LEVEL PLUGINS -->
			@yield('js-includes')
        <!-- END PAGE LEVEL PLUGINS -->
