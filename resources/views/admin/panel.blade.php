...
<script>
    ...
    function refreshAccordingPlugins(){
      ...
      //Set DataTableles
 var cdt = $('#CategoryDiv-' + catgoriesCount).find('.Catdatatables').DataTable( {
        scrollY: 150,
        paging: false,
        searching: false,
        info:false,
...
$('.catagoryPanel').on('shown.bs.collapse', function (e) {
    ...
    function addItemToTable(ele, catNum){
      ...
      // var table = $(row).closest('.panel-body').find('table');
      var table = $('#CategoryDiv-' + catNum).find('.Catdatatables')[1];
