...
<a href="javascript:;" class="btn btn-icon-only red-soft visible-xs" ng-click="confirmDelete(diettype.id)">
	...
	<div id="DietTypeModal" class="modal fade  bs-modal-lg" tabindex="-1" aria-hidden="true">
...
<div class="form-group" id="char-select2">
						...
						<div class="col-md-6">
							<div id="food-items" class="diet-food-items  col-md-9">
							<!--	<div class="panel-heading">
								...
								<div class="form-group">
									<select  class="form-control select2-diet-types-panel"  id="item-select" multiple="multiple"  style="width: 100%">
										<option></option>
										<option ng-repeat="fooditem in fooditems" id="item-@{{ fooditem.id }}" value="@{{ fooditem.id }}">@{{ fooditem.Name }}</option>
									</select>
								</div>
							 </div>
                                                         <div class="col-md-3"><button class="btn green-haze clear-all">Clear All</button></div>
						</div>
