                ...
                <div class="portlet-body">
                        <div class="mt-element-step">
                            <div class="row step-thin">
                                ...
                                <a id="acct-details">
                                    <div class="col-md-4 bg-blue-hoki mt-step-col active">
                 ...
                 <form accept-charset="UTF-8" action="/" class="require-validation"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <span style="display:none;color:red;font-weight:bold;" id="validemailerror">Email already exists, please choose another one!</span>
                        </div>
                        <div class="form-group col-md-6">    
                            <div>
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-12">
                                        <div class="form-group">    
                                            <div>
                                                <input class="form-control" id="OrgName" type="text" placeholder="Organization Name" name="OrgName" value="@{{OrgName}}" ng-model="client.OrgName" ng-required="true" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="organizationTypes" ng-required="true"  ng-model="client.orgID" >
                                                <option ng-repeat="organization in organizations" ng-selected="true" value="@{{ organization.id }}">@{{ organization.Name }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label hint">Subscription Package</label>
                                             <select class="form-control" name="Subscription" ng-required="true"  ng-model="client.PackID" >
                                                <option ng-repeat="subscription in subscriptions" ng-selected="true" value="@{{ subscription.id }}">@{{ subscription.Name }}</option>
                                            </select>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control placeholder-no-fix" type="password" id="password" autocomplete="off" placeholder="Password" name="password" value="@{{Password}}" ng-model="client.Password" ng-required="true" /><span style="display:none;color:red;font-weight:bold;" id="passwordErrorMsg1">Password length must be greater than 6 or equal to 6!</span> </div>
                            <div class="form-group">
                                <label class="control-label hint">Confirm Password</label>
                                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" id="repassword" name="password_confirmation" /> <span style="display:none;color:red;font-weight:bold;" id="passwordErrorMsg">Password fields doesn't match!</span> </div>
                            <div class='form-group'>
