          ...
          <div class="portlet light portlet-fit ">
            ...
            <div class="portlet-body">
              ...
              <table class="table table-striped table-hover table-bordered   table-items-list responsive" id="table-items-list">
                ...
                <tbody>
                  <tr ng-repeat="fooditem in fooditems" ng-if="fooditem.AkaItem == false" id="FR-@{{ fooditem.id }}" FID="@{{ fooditem.id }}">
  ...
  <div id="FoodItmsModal" class="modal fade" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-full">
      <div class="modal-content">
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="form-group mt-repeater">
                <label class="control-label">Related Foods</label>
                <div data-repeater-list="group-c" id="AkaRepeater">
                  <div data-repeater-item class="mt-repeater-item">
                    <div class="row mt-repeater-row AkaDIv">
                      <div class="col-md-5">
                        <input type="text" placeholder="Alias Name" editing-name="false" class="form-control AkaName_Class" />
                      </div>
                      <div class="col-md-5">
                ...
                <a href="javascript:;" data-repeater-create class="btn blue-hoki btn-block mt-repeater-add">
                  <i class="fa fa-plus"></i> Add Alias Name
                </a>
              </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <label for="usd" class="control-label">Select from USDA</label>
            <div style="padding-left:0px;" id="usda-select2">
              <select id="usd" class="form-control usda"  multiple  style="width: 100%">
            ...
            <br/>
          <div class="portlet-body">
            <table class="table table-striped table-hover table-bordered   table-usda-list responsive" id="table-usda-list">
              <thead>
                <tr>
                  <!-- <th> Seq. </th> -->
                  <th class="all"> Nutrient </th>
                  <th> Unit </th>
