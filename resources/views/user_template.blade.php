...
<html lang="en" ng-app="prescribeDiets">
    ...
    <head>
        ...
        <title>Prescribe Diets | User</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
       <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">

        <meta content="Prescribe Diets user portal" name="description" />
        ...
        <link rel="shortcut icon" href="<?= asset('assets/layouts/layout3/img/favicon.png') ?>" />
      </head>
    <!-- END HEAD -->
        ...
        <div class="page-wrapper">
            <div class="page-wrapper-row">
                <div class="page-wrapper-top">
                    <!-- BEGIN HEADER -->
                    @include('user.includes.header', ['active_page' => $active_page])
					<!-- END HEADER -->
                </div>
            </div>
