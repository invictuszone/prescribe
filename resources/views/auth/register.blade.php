...
<html lang="en-US" ng-app="prescribeDiets">
   ...
   <head>
       ...
       <link href="<?= asset('assets/global/css/plugins.min.css') ?>" rel="styleshee" type="text/css" />
   ...
   <body class="login page-container-bg-solid page-header-top-fixed ng-cloak">
                ...
                <form accept-charset="UTF-8" action="/" class="require-validation"
                   ...
                   <div class="row">
                       ...
                       <div class="form-group col-md-1">
                           ...
                           <select name="title" class="form-control" ng-required="true" ng-model="client.Title" ng-init="client.Title='Mr'">
                   ...
                   <div class="row">
                       <div class="form-group col-md-4">
                           ...
                           <span style="display:none;color:red;font-weight:bold;" id="validemailerror">Email Already Exsits!</span>
                       </div>
                       <div class="form-group col-md-4">
                           <div>
                                <input class="form-control" id="mask_phone" type="text" placeholder="Personal Number" name="PhoneNo" value="@{{PhoneNo}}" ng-model="client.PhoneNo" ng-required="true" />
                           </div>
                       </div>
                       <div class="form-group col-md-4">
                           <div>
                                <input class="form-control" id="mask_office_phone" type="text" placeholder="Office Number" name="OfficeNo" value="@{{OfficeNo}}" ng-model="client.OfficeNo" ng-required="true" />
                           </div>
                       </div>
                   </div>
                   <div class="row">
                   ...
                   <div class="row">
                       ...
                       <div class="form-group col-md-4">
                           ...
                           <input class="form-control placeholder-no-fix" type="text" placeholder="State/Province" name="State" value="@{{State}}" ng-model="client.State" ng-required="true"   /> </div>
                       <div class="form-group col-md-4">
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-offset-1 col-md-5">
                                   <div class="form-group">
                                       <label class="control-label hint">Organization Name</label>
                                       <input class="form-control placeholder-no-fix" type="text" ng-model="client.orgName" placeholder="Organization Name" name="OName"  />
                                   </div>
                                   <div class="form-group">
                                       <label class="control-label hint">Organization Type</label>
                       ...
                       <div id="org-btn-panel">
                           <button type="button" id="" class="btn yellow org-back">Back</button>
                       ...
                       <div class="row">
                               ...
                               <div class='form-group expiration required'>
                                   <div class="row">
                                       <div class="col-md-6 col-xs-6">
                                           ...
                                           type='text' id="mask_date3">
                                       </div>
                                       <div class="col-md-6 col-xs-6">
                                           <input
                                           class='form-control card-expiry-year' placeholder='YYYY'
                                           size='4' type='text' id="mask_date2">
                                       </div>
                                   </div>
                               </div>
                           </div>
                           ...
                           <span style="display:none;color:red;font-weight:bold;" id="errorMsg">Please accept our terms and conditions in order to proceed!</span>
                               <button type="button" id="register-back-btn" class="btn yellow acct-back">Back</button>
                               <button type='submit' class="submit btn btn-primary uppercase pull-right submit-button">Submit</button>
                           </div>
                           </div>
                       </div>
                       </div>
                       <div id="register-submit">
                         <div class="col-md-12" style="text-align: center; margin-top: 50px;">
                           <h2 class="heading-1">Initializing Dataset</h2>
                           <h2 class="heading-2">Setting up</h2>
                         </div>
                         <div class="col-md-12">
   ...
   <![endif]-->
       ...
       <script type="text/javascript">
            ...
            "mask": "(999) 999-9999"
             ...
             $("#mask_office_phone").inputmask("mask", {
            "mask": "(999) 999-9999"
        });
             $("#mask_date2").inputmask("y", {
            "placeholder": "yyyy"
        });
              $("#mask_date3").inputmask("m", {
            "placeholder": "MM"
        });
