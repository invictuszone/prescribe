@extends('superadmin_template', ['active_page' => 'sub_packages'])
				...
				<div class="col-md-12">
					...
					<div class="portlet light portlet-fit ">
						<div class="portlet-title">
							...
							<div class="actions">
								<button id="btn-add" class="btn btn-circle blue-hoki" ng-click="toggle('add', 0, 'subscriptions')">
				...
				<div class="modal-body">
                    ...
                    ng-show="frmSubscription.name.$invalid && frmSubscription.name.$touched">Field is required</span>
							...
							<div class="form-group">
  								...
  								<label class="col-md-3 control-label">Max Staff</label>
  								<div class="col-md-3">
							...
							<div class="form-group">
									...
									<div class="col-md-9">
  									<input type="number" min="1" class="form-control" value="@{{Price}}" ng-model="organization.Price">
  								</div>
									<br/>
